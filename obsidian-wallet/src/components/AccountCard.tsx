...
import { Copy, Check, Eye, EyeOff, QrCode, Plus } from 'lucide-react';
...
export const AccountCard: React.FC<AccountCardProps> = ({ onOpenReceiveModal }) => {
  ...
  const handleQuickNewSub = (e: React.MouseEvent) => {
    e.stopPropagation();
    generateNewSubaddress('Quick Subaddress');
  ...
  return (
    <div className="px-4 pt-4 pb-2 flex flex-col items-center text-center">
      ...
      <div className="flex items-center gap-2 mb-1.5">
        <div className="w-5 h-5 rounded-full bg-gradient-to-tr from-orange-500 via-amber-500 to-yellow-400 border border-slate-700 shadow-sm flex items-center justify-center text-[10px] font-bold text-slate-950">
