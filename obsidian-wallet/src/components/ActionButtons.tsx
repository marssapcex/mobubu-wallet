  ...
  return (
    <div className="grid grid-cols-4 gap-2 px-5 py-3">
      ...
      <div className="flex flex-col items-center gap-1.5">
        <button
          onClick={onOpenSwap}
          className="w-11 h-11 rounded-full bg-orange-600 hover:bg-orange-500 active:scale-95 border border-orange-500 text-white flex items-center justify-center transition-all shadow-lg shadow-orange-600/30 cursor-pointer group"
